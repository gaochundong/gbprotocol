...
/**
 * 终端􏰉􏱀􏰏􏰙􏱁终端􏰉􏱀􏰏􏰙􏱁平台设置终端参数 - 参数项 - 音视频参数设置
 */
@NoArgsConstructor
public class JT1078_Message_Content_0x8103_PI_0x0075 extends JT808_Message_Content_0x8103_ParameterItem<JT1078ProtocolVersion> {
