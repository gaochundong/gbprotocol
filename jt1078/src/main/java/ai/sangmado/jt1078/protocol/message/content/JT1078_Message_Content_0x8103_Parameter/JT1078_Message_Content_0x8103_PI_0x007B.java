...
/**
 * 终端􏰉􏱀􏰏􏰙􏱁终端􏰉􏱀􏰏􏰙􏱁平台设置终端参数 - 参数项 - 图像分析报警参数设置
 */
@NoArgsConstructor
public class JT1078_Message_Content_0x8103_PI_0x007B extends JT808_Message_Content_0x8103_ParameterItem<JT1078ProtocolVersion> {

    @Override
    public JT1078_Message_Content_0x8103_ParameterItemId getParameterItemId() {
        return JT1078_Message_Content_0x8103_ParameterItemId.JT1078_0x8103_0x007B;
    }
