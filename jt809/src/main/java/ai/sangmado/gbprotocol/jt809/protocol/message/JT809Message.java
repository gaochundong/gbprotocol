...
@Slf4j
@NoArgsConstructor
public class JT809Message implements IJT809Message<JT809MessageHeader, JT809MessageContent> {
    ...
    private void deserializeWithBuffer(ISpecificationContext ctx, IJT809MessageBufferReader reader, ByteBuffer buf) {
        ...
        // 读取消息头
        this.header = JT809MessageReader.readMessageHeader(ctx, bufReader);
        ...
        // 读取消息体
        this.content = JT809MessageReader.readMessageContent(ctx, bufReader, header);
