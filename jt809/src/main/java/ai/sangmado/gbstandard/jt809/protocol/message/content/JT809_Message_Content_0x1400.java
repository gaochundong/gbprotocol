package ai.sangmado.gbstandard.jt809.protocol.message.content;

import ai.sangmado.gbstandard.jt809.protocol.ISpecificationContext;
import ai.sangmado.gbstandard.jt809.protocol.encoding.IJT809MessageBufferReader;
import ai.sangmado.gbstandard.jt809.protocol.encoding.IJT809MessageBufferWriter;
import ai.sangmado.gbstandard.jt809.protocol.enums.JT809MessageId;
import ai.sangmado.gbstandard.jt809.protocol.enums.JT809SubMessageId;
import ai.sangmado.gbstandard.jt809.protocol.exceptions.UnsupportedJT809OperationException;
import ai.sangmado.gbstandard.jt809.protocol.message.content.JT809_Message_Content_0x1400_Sub.JT809_Message_Content_0x1400_SubMessage;
import ai.sangmado.gbstandard.jt809.protocol.message.content.JT809_Message_Content_0x1400_Sub.JT809_Message_Content_0x1400_SubMessageRegistration;
import lombok.*;
