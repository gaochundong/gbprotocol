...
/**
 * 终端􏰉􏱀􏰏􏰙􏱁终端􏰉􏱀􏰏􏰙􏱁平台设置终端参数 - 参数项 - SMS消息重传次数
 */
@NoArgsConstructor
public class JT808_Message_Content_0x8103_PI_0x0007 extends JT808_Message_Content_0x8103_ParameterItem<JT808ProtocolVersion> {

    @Override
    public JT808_Message_Content_0x8103_ParameterItemId getParameterItemId() {
        return JT808_Message_Content_0x8103_ParameterItemId.JT808_0x8103_0x0007;
    }
    ...
    @Getter
    @Setter
    private Integer smsRetransmissionTimes;
