...
@Setter
@NoArgsConstructor
public class JT808MessageHeaderMessageContentProperty2013 extends JT808MessageHeaderMessageContentProperty {
    ...
    @Builder
    public JT808MessageHeaderMessageContentProperty2013(
    ...
    public JT808MessageHeaderMessageContentProperty clone() {
        return JT808MessageHeaderMessageContentProperty2013.builder()
