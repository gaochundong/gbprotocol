...
public class GB32960DeviceMessageHeaderRegistration {
    private static final Map<GB32960ProtocolVersion, BiFunction<ISpecificationContext, IGB32960MessageBufferReader, GB32960DeviceMessageHeader>> decoders = new HashMap<>(3);

    public static Map<GB32960ProtocolVersion, BiFunction<ISpecificationContext, IGB32960MessageBufferReader, GB32960DeviceMessageHeader>> getDecoders() {
        return decoders;
    }

    public static void register(GB32960ProtocolVersion protocolVersion, BiFunction<ISpecificationContext, IGB32960MessageBufferReader, GB32960DeviceMessageHeader> headerDecoder) {
