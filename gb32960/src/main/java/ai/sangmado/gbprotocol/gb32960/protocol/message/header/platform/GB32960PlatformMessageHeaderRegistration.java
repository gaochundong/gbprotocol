...
public class GB32960PlatformMessageHeaderRegistration {
    private static final Map<GB32960ProtocolVersion, BiFunction<ISpecificationContext, IGB32960MessageBufferReader, GB32960PlatformMessageHeader>> decoders = new HashMap<>(3);

    public static Map<GB32960ProtocolVersion, BiFunction<ISpecificationContext, IGB32960MessageBufferReader, GB32960PlatformMessageHeader>> getDecoders() {
        return decoders;
    }

    public static void register(GB32960ProtocolVersion protocolVersion, BiFunction<ISpecificationContext, IGB32960MessageBufferReader, GB32960PlatformMessageHeader> headerDecoder) {
