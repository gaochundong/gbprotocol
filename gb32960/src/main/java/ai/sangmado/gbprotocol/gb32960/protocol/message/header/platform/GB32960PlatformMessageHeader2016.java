...
@Setter
@NoArgsConstructor
public class GB32960PlatformMessageHeader2016 extends GB32960PlatformMessageHeader {
    public static final GB32960ProtocolVersion PROTOCOL_VERSION = V2016;

    @Builder
    public GB32960PlatformMessageHeader2016(
            GB32960PlatformCommandId commandId,
    ...
    @Override
    public GB32960PlatformMessageHeader clone() {
        try {
            return GB32960PlatformMessageHeader2016.builder()
